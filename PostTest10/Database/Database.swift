...
extension Database {
    ...
    func createTable() {
        ...
        ////                print("id: \(user[id]), first name: \(user[firstName]), last name: \(user[lastName]), email: \(user[email]), phone number: \(user[phone]), job id: \(user[jobID]), salary: \(user[salary]), commisiion: \(user[commission_pct]), manager id: \(user[managerID]), department: \(user[departmentID])")
        ////            }
        ////        } catch {
